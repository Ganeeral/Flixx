...
export default function Home() {
  ...
  return (
    <div
      className={`max-w-[248px] z-30 fixed tablet-s:hidden w-full`}
      style={{ maxWidth: isColumn ? "0px" : "248px" }}
    >
      <div className="max-w-[248px]">
        <motion.div
          animate={controls}
          className="sideBar justify-between max-w-[248px] animate duration-300 relative flex flex-col h-screen group "
        >
          <div>
